    ...
    <View style={styles.container}>
      <ScrollView style = {styles.scrollScreen} >
        ...
        <View style = {{marginTop : 20 ,marginBottom : 20 , }}>
                  <Text style = {{fontSize : 20  ,alignSelf :'center'}}> <Octicons name="note" size={25} color="#34dbeb" /> Time Table</Text>
        </View>
        <View style = {{marginTop : 30  }}>
                  <Text style = {{fontSize : 20 ,alignItems:'flex-start', marginLeft : 30}}>  Level 1</Text>
        </View>
      <TouchableOpacity>
       <View style = {styles.avatar}>
        ...
        <View style = {{marginTop : 30  }}>
                  <Text style = {{fontSize : 20 ,alignItems:'flex-start', marginLeft : 30}}>  Level 2</Text>
        </View>
       ...
       <View style = {styles.avatar}>
        ...
        <View style = {{marginTop : 30  }}>
                  <Text style = {{fontSize : 20 ,alignItems:'flex-start', marginLeft : 30}}>  Level 3</Text>
        </View>
      ...
      <ScrollView style = {styles.scrollScreen} >
       ...
       <View style = {styles.avatar}>
        ...
        <View style = {styles.uploadButton} >
           <MaterialCommunityIcons onPress ={pickImage1} name="image-plus" size={24} color="#02b2f2" />
        </View>
       </View>
       ...
       <View style = {styles.avatar}>
        <Image source={{ uri: image2 }} style={{  
         ...
         <View style = {styles.uploadButton} >
           <MaterialCommunityIcons onPress ={pickImage2} name="image-plus" size={24} color="#02b2f2" />
         </View>
        </View>
       ...
       <View style = {styles.avatar}>
        <Image source={{ uri: image3 }} style={{  
          ...
          <View style = {styles.uploadButton} >
           <MaterialCommunityIcons onPress ={pickImage3} name="image-plus" size={24} color="#02b2f2" />
         </View>
