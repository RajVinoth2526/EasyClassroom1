...
export default function Level1Screen({ navigation }) {
    ...
    useEffect(() =>{
        ...
        async function fetchSubjects() {
          ...
          const querySnapshot = await  db.collection("CoursesName-"+faculty).doc(department).collection(level1).doc(year).collection("CourseNames").orderBy("created").get();
        ...
        if (!doc.exists) {
          ...
          navigation.navigate("EntrollScreen",{Password : Entroll,Faculty : faculty,Department : department,Level :level1, Year : year,CourseID : courseid,CourseName:CourseName,CoursenameID:CoursenameID,UserID : UserID});
          
         
        } else {
          
          navigation.navigate("CourseScreen",{Faculty : faculty,Department : department,Level :level1,CourseID : courseid,CourseName:CourseName,CoursenameID:CoursenameID,Year : year,UserID : UserID});
